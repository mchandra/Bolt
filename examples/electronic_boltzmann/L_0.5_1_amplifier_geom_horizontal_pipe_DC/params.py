...
right_dirichlet_boundary_index  = 19  # Default value is N_q1-1  
...
horizontal_boundary_lims = [(0., 0.625)] # boundary lims along q1
...
device_allocation        = [0, 0, 0, 0, 0, 0] # No. of items in list should match number of mpiprocs
