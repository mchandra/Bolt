...
q1_partition = [35./80, 10./80, 35./80] # List of the fractional ranges of each subdomain in q1
# The above indices correspond to  x = [-4.5700, -0.0075, 26.286, 29.5287, 33.010, 50]
# TODO : Automate the indices using coords
q2_partition = [10./40, 15./40, 15./40] # List of the fractional ranges of each subdomain in q2
...
#left_dirichlet_boundary_index_2   = 40  # Default value is 0 # TODO : Testing!
right_dirichlet_boundary_index  = 79  # Default value is N_q1-1  
...
horizontal_boundaries    = [10, 10, 25, 25] # index of boundary axis along q2
horizontal_boundary_lims = [(0., 0.875), (1.125, 2.0), (0.875, 0.975), (1.025, 1.125)] # boundary lims along q1

vertical_boundaries    = [35, 45] # index of boundary axis along q2
vertical_boundary_lims = [(0.25, 1.0), (0.25, 1.0)] # boundary lims along q1
