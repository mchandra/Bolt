...
q1_partition = [25./120, 10./120, 85./120] # List of the fractional ranges of each subdomain in q1
# The above indices correspond to  x = [-4.5700, -0.0075, 26.286, 29.5287, 33.010, 50]
# TODO : Automate the indices using coords
q2_partition = [20./40, 20./40] # List of the fractional ranges of each subdomain in q2
...
horizontal_boundaries    = [20, 20] # index of boundary axis along q2
horizontal_boundary_lims = [(0., 0.625), (0.875, 3.0)] # boundary lims along q1

vertical_boundaries    = [25, 35] # index of boundary axis along q2
vertical_boundary_lims = [(0.05, 1.0), (0.5, 1.0)] # boundary lims along q1
...
device_allocation        = [0, 1, 2, 3, 4, 5] # No. of items in list should match number of mpiprocs
