...
q1_partition = [25./120, 20./120, 75./120] # List of the fractional ranges of each subdomain in q1
# The above indices correspond to  x = [-4.5700, -0.0075, 26.286, 29.5287, 33.010, 50]
# TODO : Automate the indices using coords
q2_partition = [20./60, 40./60] # List of the fractional ranges of each subdomain in q2
