...
q1_partition = [40./120, 40./120, 40./120] # List of the fractional ranges of each subdomain in q1
# The above indices correspond to  x = [-4.5700, -0.0075, 26.286, 29.5287, 33.010, 50]
# TODO : Automate the indices using coords
q2_partition = [70./150, 40./150, 40./150] # List of the fractional ranges of each subdomain in q2
...
top_dirichlet_boundary_index    = 74 # Default value is N_q2-1
...
horizontal_boundaries    = [35, 55] # index of boundary axis along q2
horizontal_boundary_lims = [(-0.1666, 0.1666), (-0.1666, 0.1666)] # boundary lims along q1

vertical_boundaries    = [20, 40] # index of boundary axis along q2
vertical_boundary_lims = [(-0.1666, 0.1666), (-0.1666, 0.1666)] # boundary lims along q1
...
# Time parameters:
dt      = 0.025/24 # ps #Data before 137.5 ps is using dt = 0.025/16
t_final = 300     # ps
