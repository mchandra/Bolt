...
#                     )
    ...
    fermi_dirac_in[:domain.N_p2/2]   = 0.
    fermi_dirac_in[domain.N_p2/2+1:] = 0.
...
#                      )
    # TODO : Testing - set zero everywhere except index 3*N_p2/4 (injection towards top)
    fermi_dirac_out = vel_drift_x_out*p_y
    fermi_dirac_out[:3*domain.N_p2/4]   = 0.
    fermi_dirac_out[3*domain.N_p2/4 + 1:] = 0.
