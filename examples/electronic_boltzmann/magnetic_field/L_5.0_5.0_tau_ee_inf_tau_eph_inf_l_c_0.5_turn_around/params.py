...
right_dirichlet_boundary_index  = 124  # Default value is N_q1-1  
...
top_dirichlet_boundary_index    = 124 # Default value is N_q2-1
...
dont_compute             = [0, 0, 0, 0]

# Block (mirror) selected boundaries of specified patches
blocked_left_bc          = []
blocked_right_bc         = []
blocked_bottom_bc        = []
blocked_top_bc           = []
...
contact_start         = 4.8 # um
contact_end           = 4.9 # um
contact_geometry      = "turn_around" # Contacts on either side of the device
...
l_c     = 0.5 # See src/electronic_boltzmann/advection_terms.py for description
B3_mean = 1. # T
