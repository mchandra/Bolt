...
pl.plot(time_array[time_index], np.log10(np.abs(collector_array[time_index])))

#pl.plot(time_array[time_index], (emitter_voltage_array)[time_index])
#pl.plot(time_array[time_index], np.log10(collector_voltage_array[time_index]))
