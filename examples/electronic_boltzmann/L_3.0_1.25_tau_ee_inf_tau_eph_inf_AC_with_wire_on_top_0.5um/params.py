...
q2_partition = [72./108, 36./108] # List of the fractional ranges of each subdomain in q2
...
right_dirichlet_boundary_index  = 215  # Default value is N_q1-1  
...
top_dirichlet_boundary_index    = 107 # Default value is N_q2-1
...
horizontal_boundaries    = [72] # index of boundary axis along q2
horizontal_boundary_lims = [(0.25, 3.5)] # boundary lims along q1
