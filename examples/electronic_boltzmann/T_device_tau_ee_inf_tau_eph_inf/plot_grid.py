...
#        d_array.append(np.sqrt((x_array[i] - x_array[i-1])**2 + (y_array[i] - y_array[i-1])**2))
#    
#    d_array = np.array(d_array)
    
#    pl.subplot(211)
#    pl.plot(np.sqrt((x_array - np.roll(x_array, 1))**2 + (y_array - np.roll(y_array, 1))**2), '-o', ms = 3, color = 'r', alpha = 0.5)
    #pl.plot(d_array, '-o', color = 'k', ms = 2)
    
#    pl.axvline(0, color = 'k', ls = '--')
#    pl.axvline(80, color = 'k', ls = '--')
#    pl.axvline(160, color = 'k', ls = '--')
#    pl.axvline(240, color = 'k', ls = '--')
#    
#    pl.xlabel(r'N')
#    pl.ylabel(r'd (um)')
...
#    pl.plot(x_array[120], y_array[120], 'o', color = 'k', ms = 3, alpha = 0.5)
    ...
    pl.plot(radius*np.cos(theta), radius*np.sin(theta), color = 'k', alpha = 0.5)
