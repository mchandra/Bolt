...
#    file_number = -1
    ...
    emitter_indices   = q2 < 0.1+0*dy
    collector_indices = q2 < 1. + 2*dy
    base_indices      = q2 > 0.1 - 0*dy
...
pl.subplot(211)
pl.plot(time_array[time_index], emitter_array[time_index], label = "Emitter")
pl.plot(time_array[time_index], collector_array[time_index], label = "Collector")
pl.plot(time_array[time_index], base_array[time_index], label = "Base")
...
pl.subplot(212)
pl.plot(time_array[time_index], (emitter_voltage_array)[time_index], label = "Emitter")
pl.plot(time_array[time_index], collector_voltage_array[time_index], label = "Collector")
