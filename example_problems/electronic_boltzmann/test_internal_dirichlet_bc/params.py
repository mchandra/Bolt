...
horizontal_boundary_lims = [(-1, 0.), (-0.3334, 0.3334)] # boundary lims along q1

vertical_boundaries    = [] # index of boundary axis along q2
vertical_boundary_lims = [(-1., 1), (-0.3334, 0.3334)] # boundary lims along q1
...
device_allocation        = [0, 0, 1, 1] # No. of items in list should match number of mpiprocs
dont_compute             = [0, 0, 0, 0]

blocked_left_bc          = [0, 2]
blocked_right_bc         = [0]
blocked_bottom_bc        = [0, 2]
blocked_top_bc           = [0]
