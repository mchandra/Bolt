...
q1_partition = [75./200, 50./200, 75./200] # List of the fractional ranges of each subdomain in q1
# The above indices correspond to  x = [-4.5700, -0.0075, 26.286, 29.5287, 33.010, 50]
# TODO : Automate the indices using coords
q2_partition = [150./200, 50./200] # List of the fractional ranges of each subdomain in q2
...
right_dirichlet_boundary_index  = 199  # Default value is N_q1-1  
...
horizontal_boundaries    = [150, 150] # index of boundary axis along q2
horizontal_boundary_lims = [(0., 1.5), (2.5, 4.)] # boundary lims along q1

vertical_boundaries    = [75, 125] # index of boundary axis along q2
vertical_boundary_lims = [(0, 3.), (0., 3.)] # boundary lims along q1
