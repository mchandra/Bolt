...
q1_partition = [40./80, 40./80] # List of the fractional ranges of each subdomain in q1
# The above indices correspond to  x = [-4.5700, -0.0075, 26.286, 29.5287, 33.010, 50]
# TODO : Automate the indices using coords
q2_partition = [90./200, 20./200, 90./200] # List of the fractional ranges of each subdomain in q2
...
right_dirichlet_boundary_index  = 319  # Default value is N_q1-1  
...
horizontal_boundaries    = [90, 110] # index of boundary axis along q2
horizontal_boundary_lims = [(0., 8.0), (0., 8.0)] # boundary lims along q1

vertical_boundaries    = [160, 160] # index of boundary axis along q2
vertical_boundary_lims = [(0., 4.5), (5.5, 10.)] # boundary lims along q1
...
# Time parameters:
dt      = 0.025/8  # ps #Data before 137.5 ps is using dt = 0.025/16
t_final = 500.     # ps
...
device_allocation        = [0, 0, 0, 1, 1, 1] # No. of items in list should match number of mpiprocs
