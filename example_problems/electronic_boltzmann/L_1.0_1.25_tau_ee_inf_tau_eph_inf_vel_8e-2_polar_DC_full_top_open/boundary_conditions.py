...
def f_left(f, t, q1, q2, p1, p2, p3, params):
    ...
    if (params.contact_geometry=="straight"):
        ...
        cond_out = ((params.y >= 4.85) & (params.y <= 4.90))

        f_left = cond_in*fermi_dirac_in + (1 - cond_in)*f
...
def f_top(f, t, q1, q2, p1, p2, p3, params):
    ...
    if (params.contact_geometry=="straight"):
        ...
        q1_contact_start = 0.#params.contact_start
        q1_contact_end   = 1.#params.contact_end
