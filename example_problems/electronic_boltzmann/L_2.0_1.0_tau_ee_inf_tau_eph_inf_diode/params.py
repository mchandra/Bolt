...
q1_partition = [50./150, 50./150, 50./150] # List of the fractional ranges of each subdomain in q1
# The above indices correspond to  x = [-4.5700, -0.0075, 26.286, 29.5287, 33.010, 50]
# TODO : Automate the indices using coords
q2_partition = [15./50, 20./50, 15./50] # List of the fractional ranges of each subdomain in q2
...
horizontal_boundaries    = [15, 35] # index of boundary axis along q2
horizontal_boundary_lims = [(1., 2.), (1., 2.)] # boundary lims along q1

vertical_boundaries    = [50, 50, 100, 100] # index of boundary axis along q2
vertical_boundary_lims = [(0., 0.3), (0.7, 1.0), (0., 0.3), (0.7, 1.0)] # boundary lims along q1
...
device_allocation        = [0, 0, 0, 0, 1, 1, 1, 1, 1] # No. of items in list should match number of mpiprocs
