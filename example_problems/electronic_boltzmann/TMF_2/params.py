...
left_dirichlet_boundary_index   = 189  # Default value is 0
...
def band_velocity(p1, p2):
    ...
    # TODO : This function will be called inside C_p() in advection_terms at each time step
