...
# Example qsub script for NewRiver
...
export PYTHONPATH=/work/cascades/adbhutg/bolt_test_B:/home/adbhutg/newriver_python_pkgs/lib/python/
LD_PRELOAD=/lib64/libstdc++.so.6.0.19 mpirun -np $PBS_NP python main.py
