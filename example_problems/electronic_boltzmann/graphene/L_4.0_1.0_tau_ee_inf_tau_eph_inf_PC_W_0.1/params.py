...
q1_partition = [100./200, 100./200] # List of the fractional ranges of each subdomain in q1
...
vertical_boundaries    = [100, 100] # index of boundary axis along q2
vertical_boundary_lims = [(0.0, 0.45), (0.55, 1.0)] # boundary lims along q1
