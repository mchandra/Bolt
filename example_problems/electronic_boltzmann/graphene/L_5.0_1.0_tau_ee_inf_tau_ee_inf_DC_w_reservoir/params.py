...
q1_partition = [20./120, 20./120, 40./120, 20./120, 20./120] # List of the fractional ranges of each subdomain in q1
# The above indices correspond to  x = [-4.5700, -0.0075, 26.286, 29.5287, 33.010, 50]
# TODO : Automate the indices using coords
q2_partition = [5./55, 10./55, 5./55, 35./55] # List of the fractional ranges of each subdomain in q2
...
horizontal_boundaries    = [5, 15, 15, 20, 20] # index of boundary axis along q2
horizontal_boundary_lims = [(0.5, 2.5), (0.5, 1.0), (2.0, 2.5), (0., 0.5), (2.5, 3.0)] # boundary lims along q1

vertical_boundaries    = [20, 20, 40, 80, 100, 100] # index of boundary axis along q2
vertical_boundary_lims = [(0., 0.125), (0.375, 0.5), (0.375, 1.375), (0.375, 1.375), (0., 0.125), (0.375, 0.5)] # boundary lims along q1
